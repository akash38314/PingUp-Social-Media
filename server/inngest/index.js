    ...
    async ({ event, step }) => {
        ...
        await step.run('send-connection-request-reminder', async () => {
            ...
            if (!connection || connection.status === "accepted") {
                return { message: "Already accepted or not found" };
            }
...
// Inngest Function to send notification of unseen messages (CRON job)
    ...
    async ({ step }) => {
        ...
        for (const userId in unseenCount) {
            ...
            <div style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <p>You have ${unseenCount[userId]} unseen message(s) waiting for you!</p>
...
// Create an array of all Inngest functions
